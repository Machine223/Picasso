...
import { BrushElementCreator } from './brush-element-creator';

describe('BrushElementCreator', () => {
  let createRenderer2Spy: jasmine.Spy;
  let instance: BrushElementCreator;
  ...
  beforeEach(() => {
    ...
    instance = new BrushElementCreator(rendererFactory);
  ...
  it('#createCircle should call setAttribute 6 times and appendChild 1 time', () => {
  ...
  it('#createPath should call setAttribute 7 times and removeLastTemporaryPart 1 time', () => {
    const shape = new Path(colorsService, toolProperties);
    const spy = spyOn(instance, 'removeLastTemporaryPart');
    instance.createPath(shape, 2);
